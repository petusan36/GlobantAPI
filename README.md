...
>To stop the running  container you enter into this one with ``docker exec -it apig bash`` and run kill command to force it to stop ``kill 1`` sending a signal qith ``1`` value.
